                    ...
                    <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
                        ...
                        <li class="nav-item dropdown">
                            <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"
                                aria-expanded="false"> <img src="asset/img/profile.jpg" alt="user-img" width="36"
                                    class="img-circle"><span>Ritesh</span></span> </a>
                            <ul class="dropdown-menu dropdown-user">
                                <li>
                                    <div class="user-box">
                                        ...
                                        <div class="u-text">
                                            <h4>Ritesh</h4>
                                            <p class="text-muted">riteshkumawat1003@gmail.com</p><a href="profile.html"
