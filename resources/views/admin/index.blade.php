	...
	<div class="wrapper">
		<div class="main-header">
				...
				<div class="container-fluid">
					...
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
						...
						<li class="nav-item dropdown">
							<a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false"> <img src="asset/img/profile.jpg" alt="user-img" width="36" class="img-circle"><span >Ritesh</span></span> </a>
							<ul class="dropdown-menu dropdown-user">
								<li>
									<div class="user-box">
										...
										<div class="u-text">
											<h4>Ritesh</h4>
											<p class="text-muted">riteshkumawat1003@gmail.com</p><a href="profile.html" class="btn btn-rounded btn-danger btn-sm">View Profile</a></div>
										</div>
									</li>
									<div class="dropdown-divider"></div>
			...
			<div class="main-panel">
				<div class="content">
					<div class="container-fluid">
						<h4 class="page-title" align="center">Admin Dashboard of MultiApp</h4>
						<div class="row">
							<div class="col-md-3">
								...
								<div class="card card-stats card-success">
									<div class="card-body ">
										<div class="row">
											...
											<div class="col-7 d-flex align-items-center">
												<div class="numbers">
													<p class="card-category">Transcation</p>
							...
							<div class="col-md-3">
								<div class="card">
									<div class="card-header">
										<h4 class="card-title">Above Avg Transcation</h4>
									...
									<div class="card-footer">
										<div class="legend"><i class="la la-circle text-primary"></i> APL</div>
									</div>
								</div>
							</div>
							<div class="col-md-9">
